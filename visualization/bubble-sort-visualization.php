...
<div class="visualization">
    ...
    <div class="controls">
        ...
        <button class="btn" id="selection-start-btn" disabled>🎬 Start Sorting</button>
        <button class="btn btn-secondary" id="selection-reset-btn">🔄 New Array</button>
        <button class="btn btn-secondary" id="selection-prev-btn" disabled>⏮️</button>
        <button class="btn btn-secondary" id="selection-next-btn" disabled>⏭️</button>
